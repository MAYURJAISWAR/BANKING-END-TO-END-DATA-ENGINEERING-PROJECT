        ...
        create or replace transient table banking_data.staging_schema_1_transformed_data_schema.district
         as
        (
...
FROM banking_data.staging_schema_1_staging_schema_1.district_tbl
        );
